...
export default function ConductorOnboarding() {
  ...
  useEffect(() => {
    ...
    if (isUserLoaded && user?.publicMetadata?.role === "Conductor") {
    ...
    <div className="flex items-center justify-center min-h-screen bg-muted/40">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Proporciona tus datos para continuar como conductor</CardDescription>
        </CardHeader>
        <Form {...form}>
