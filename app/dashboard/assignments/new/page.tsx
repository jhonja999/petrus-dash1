...
export default function NewAssignmentPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const [trucksData, driversData, customersData] = await Promise.all([
          fetchTrucks("Activo"),
          fetchUsers("Conductor", "Activo"),
          fetchCustomers(),
        ])
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Asigna un camión a un conductor para entrega de combustible</p>
      </div>
